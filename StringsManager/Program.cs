...
namespace MeuApp
{
    class Program
    {
        ...
        static void Aula0()
        {
            ...
            var texto4 = @"/Aqui podemos escrever quantas linhas quisermos e por ai vai//";
        ...
        {
            var texto = "Testando";
            Console.WriteLine(texto.CompareTo("Testando")); //Retornar Verdadeiro
            Console.WriteLine(texto.CompareTo("testando"));// Retorna Falso
            Console.WriteLine(texto.CompareTo(""));
            Console.WriteLine(texto.CompareTo(null));
            
        }

        static void Aula2()
        {
            var texto = "Este é apenas um texto de teste";
